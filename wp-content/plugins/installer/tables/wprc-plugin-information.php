		...
		if ( 'install' == $status ) {
			...
			/*if ( is_dir( WP_PLUGIN_DIR . '/' . $api->slug ) ) {
				...
				if ( empty($installed_plugin) ) {
					...
					$key = array_shift( $keys ); //Use the first plugin regardless of the name, Could have issues for multiple-plugins in one directory if they share different version numbers

...
# main config
PLUGINSLUG='better-wp-security' # returns basename of current directory
CURRENTDIR=`pwd`
MAINFILE="better-wp-security.php" # this should be the name of your main php file in the wordpress plugin

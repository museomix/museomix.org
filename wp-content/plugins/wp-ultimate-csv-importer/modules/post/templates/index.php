	...
	<!-- The global progress bar -->
          <div class="form-group" style="padding-bottom:20px;">
				 ...
				 <img src="<?php echo WP_CONTENT_URL; ?>/plugins/<?php echo WP_CONST_ULTIMATE_CSV_IMP_SLUG; ?>/images/pro_icon.gif" title="PRO Feature" />
                                ...
                                <input type='button' name='clearform' id='clearform' title = '<?php echo __("Clear",'wp-ultimate-csv-importer'); ?>' value='<?php echo $impCE->reduceStringLength(__("Clear",'wp-ultimate-csv-importer'),'Clear'); ?>' onclick="Reload();" class='btn btn-warning' style="margin-right:15px;"/>
                          
                               <input type='submit' name='importfile' id='importfile' title = '<?php echo __("Next",'wp-ultimate-csv-importer'); ?>' value='<?php echo $impCE->reduceStringLength(__("Next",'wp-ultimate-csv-importer'),'Next');?> >>' disabled  class='btn btn-primary' style="margin-right:15px;"/>
                                </div>
                                </tr>
                                </table>
...
<!--	<div class='section-one' align='center'>
	...
	<?php if(isset($_REQUEST['__module']) && $_REQUEST['__module']=='custompost'){ ?>
		<div class='importstatus' style='display:true;'>
			...
			<div style = 'float:left'> <label id="importalign"><?php echo __('Select Post Type','wp-ultimate-csv-importer'); ?> </label> <span class="mandatory"> * </span> </div>
			...
			{ ?>
				<tr>
					...
					?>
					<!--<option value="add_custom<?php print($count); ?>"><?php echo __('Add Custom Field','wp-ultimate-csv-importer'); ?></option>-->
					</select>
		...
		<input type='button' id='clear_mapping' class='clear_mapping btn btn-warning' name='clear_mapping' title = '<?php echo __("Clear Mapping",'wp-ultimate-csv-importer'); ?>' value='<?php echo __('Clear','wp-ultimate-csv-importer');echo ' '; echo $impCE->reduceStringLength(__(' Mapping','wp-ultimate-csv-importer'),'Mapping'); ?>' onclick='clearMapping();' style = 'float:left'/>
		<span style = ''>

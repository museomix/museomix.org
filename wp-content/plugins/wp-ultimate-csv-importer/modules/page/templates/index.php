						...
						<form action='<?php echo esc_url(add_query_arg(array('page' => WP_CONST_ULTIMATE_CSV_IMP_SLUG.'/index.php', '__module' => sanitize_text_field($_REQUEST['__module']), 'step' => 'mapping_settings'), $impCE->baseUrl)); ?>'
							...
							<div class="importfile" align='center'>
								...
								<div class="container">
									...
									<input type="hidden" id="uploaddir" value="<?php if (isset($uploadDir['basedir'])) {
											...
											<tr>
												<div style="float:right;">
													...
													<input type='submit' name='importfile' id='importfile'
														   ...
														   value='<?php echo $impCE->reduceStringLength(esc_attr_e("Next", 'wp-ultimate-csv-importer'), 'Next');
														   echo __(" >>"); ?>' disabled
				 ...
				 style="margin-top: 6px;float:right;"/>
						...
						<div id='mappingheader' class='mappingheader'>
							...
							<table style="font-size: 12px;" class="table table-striped" id='FIELDGRP'>
								...
								<tr>
									<td colspan='4' class="left_align columnheader"
										...
										<div id='custfield_core' style='font-size:18px; font-family:times;'><b><?php echo esc_html__('WordPress Fields:','wp-ultimate-csv-importer'); ?></b>
										</div>
									</td>
								</tr>
								<tr>
							...
							<table>
								<tr>
									<td colspan='4'>
										<input type='button' class='btn btn-primary' name='addcustomfd'
							...
							if (in_array('all-in-one-seo-pack/all_in_one_seo_pack.php', $active_plugins)) {
								...
								<table style="font-size: 12px;" class="table table-striped" id='SEO_FIELDGRP'>
									...
									<input type='hidden' id='seofields' name='seofields'

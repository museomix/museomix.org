	...
	<!-- The global progress bar -->
        <div class="form-group" style="padding-bottom:20px;">
				...
				<img src="<?php echo WP_CONTENT_URL; ?>/plugins/<?php echo WP_CONST_ULTIMATE_CSV_IMP_SLUG; ?>/images/pro_icon.gif" title="PRO Feature" />
                                ...
                                <input type='submit' name='importfile' id='importfile' title = '<?php echo __("Next",'wp-ultimate-csv-importer'); ?>' value='<?php echo $impCE->reduceStringLength(__("Next",'wp-ultimate-csv-importer'),'Next'); echo __(" >>");?>' disabled
...
<!--	<div class='section-one' align='center'>
	...
	<?php if(isset($_REQUEST['__module']) && $_REQUEST['__module']=='custompost'){ ?>
		<div class='importstatus' style='display:true;'>
			...
			?>
                        <tr><td class="left_align columnheader"> <b><?php echo __('CSV HEADER','wp-ultimate-csv-importer'); ?></b> </td><td class="columnheader"> <b><?php echo __('WP FIELDS','wp-ultimate-csv-importer'); ?></b> </td><td > <b><?php echo __('CSV ROW','wp-ultimate-csv-importer'); ?></b> </td><td></td></tr>
			<?php

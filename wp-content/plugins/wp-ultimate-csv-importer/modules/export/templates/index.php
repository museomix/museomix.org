			...
			<div class="accordion-inner">
				<div>
					<span class="settings-icon"> <img
							src="<?php echo WP_CONTENT_URL; ?>/plugins/<?php echo WP_CONST_ULTIMATE_CSV_IMP_SLUG; ?>/images/export.png"
							width="24" height="24"/> </span>

					<label><h3
							id="exporttitle"><?php echo __('Export Data With Advanced Filters', 'wp-ultimate-csv-importer'); ?></h3>
					</label>
				</div>
				<div style="margin-left:20px;">
					<form id="exportmoduleform" class="form-horizontal" method="post" name="exportmodule"
						  action="<?php echo admin_url('admin-ajax.php'); ?>" onsubmit="return export_module();">
						...
						<div class="table-responsive">
							<table style='width:100%;' class='table exportmodule'>
								<th colspan='2'><label class='h-exportmodule'><h3
											id="innertitle"><?php echo __('To export data based on the filters', 'wp-ultimate-csv-importer'); ?></h3>
									</label></th>
								<tr>
									<td><label><input type='checkbox' name='getdatawithdelimiter'
													  id='getdatawithdelimiter' value='getdatawithdelimeter'
													  onclick='addexportfilter(this.id);'/><span
												id="align"><?php echo __('Export data with auto delimiter', 'wp-ultimate-csv-importer'); ?></span></label>

										<div id='delimeter' style='padding:10px;display:none;'>
											<label
												id='delistatus'><b><?php echo __('Delimiters', 'wp-ultimate-csv-importer'); ?> </b></label>
											...
											</label><input type='text' name='others_delimiter' id='others_delimiter'
														   size=6>
											</select>
										</div>
									</td>
								...
								<tr>
									<td><label><input type='checkbox' name='getdataforspecificperiod'
													  id='getdataforspecificperiod' value='getdataforspecificperiod'
													  onclick='addexportfilter(this.id);'/><span
												id="align"><?php echo __('Export data for the specific period', 'wp-ultimate-csv-importer'); ?></span></label>

										<div id='specificperiodexport' style='padding:10px;display:none;'>
											<label
												id='periodstartfrom'><b><?php echo __('Start From', 'wp-ultimate-csv-importer'); ?> </b></label>
											<input type='text' class='form-control' name='postdatefrom'
												   style='cursor:default;width:25%;' readonly id='postdatefrom'
												   value=''/>
											<label
												id='periodendto'><b><?php echo __('End To', 'wp-ultimate-csv-importer'); ?> </b></label>
											<input type='text' class='form-control' name='postdateto'
												   style='cursor:default;width:25%;' readonly id='postdateto' value=''/>
											<input type='hidden' name='nonce' id='nonce'
												   value='<?php if (isset($noncedata)) {
													   echo $noncedata;
												   } ?>'>
										</div>
									</td>
								...
								<tr>
									<td><label><input type='checkbox' name='getdatawithspecificstatus'
													  id='getdatawithspecificstatus' value='getdatawithspecificstatus'
													  onclick='addexportfilter(this.id);'/><span
												id="align"><?php echo __('Export data with the specific status', 'wp-ultimate-csv-importer'); ?></span></label>

										<div id='specificstatusexport' style='padding:10px;display:none;'>
											<label
												id='status'><b><?php echo __('Status', 'wp-ultimate-csv-importer'); ?> </b></label>
								...
								<tr>
									<td><label><input type='checkbox' name='getdatabyspecificauthors'
													  id='getdatabyspecificauthors' value='getdatabyspecificauthors'
													  onclick='addexportfilter(this.id);'/><span
												id="align"><?php echo __('Export data by specific authors', 'wp-ultimate-csv-importer'); ?></span></label>

										<div id='specificauthorexport' style='padding:10px;display:none;'>
											<label
												id='authors'><b><?php echo __('Authors', 'wp-ultimate-csv-importer'); ?></b></label>
						...
						<div class="table-responsive" id="exporttable">
							<table class='table exportmodule'>
								<th colspan='2'><label class='h-exportmodule'><h3
											id="innertitle"><?php echo __('Select your module to export the data', 'wp-ultimate-csv-importer'); ?></h3>
									</label></th>
								<tr>
									<td class='exportdatatype'><label> <input type="radio" name="export"
																			  value="post"><span
												id="align"><?php echo __('Post', 'wp-ultimate-csv-importer'); ?></span>
										</label></td>
									<td class='exportdatatype'><label> <input type="radio" name="export"
																			  value="eshop"><span
												id="align"><?php echo __('Eshop', 'wp-ultimate-csv-importer'); ?></span>
										</label></td>
								</tr>
								<tr>
									<td class='exportdatatype'><label> <input type="radio" name="export"
																			  value="page"><span
												id="align"><?php echo __('Page', 'wp-ultimate-csv-importer'); ?></span>
										</label></td>
									<td class='exportdatatype'><label> <input type="radio" name="export"
																			  value="wpcommerce"><span
												id="align"><?php echo __('Wp-Commerce</span', 'wp-ultimate-csv-importer'); ?>
										</label></td>
								</tr>
								<tr>
									<td class='exportdatatype'>
										<label> <input type="radio" name="export" value="custompost"><span
												id="align"><?php echo __('Custom Post', 'wp-ultimate-csv-importer'); ?></span></label>
										<select name="export_post_type" style="margin-left:10px" id="export_post_type">
											...
											foreach (get_post_types() as $key => $value) {
												if (($value != 'featured_image') && ($value != 'attachment') && ($value != 'wpsc-product') && ($value != 'wpsc-product-file') && ($value != 'revision') && ($value != 'nav_menu_item') && ($value != 'post') && ($value != 'page') && ($value != 'wp-types-group') && ($value != 'wp-types-user-group') && ($value != 'product') && ($value != 'product_variation') && ($value != 'shop_order') && ($value != 'shop_coupon') && ($value != 'acf')) {
													?>
													<option
														id="<?php echo($value); ?>"> <?php echo($value); ?> </option>
													<?php
												}
											}
											?>
									...
									<td class='exportdatatype'><label> <input type="radio" name="export"
																			  value="woocommerce"><span
												id="align"><?php echo __('Woo-Commerce', 'wp-ultimate-csv-importer'); ?></span></label>
									</td>
								</tr>
								<tr>
									<td class='exportdatatype'><label> <input type="radio" name="export"
																			  value="category"><span
												id="align"><?php echo __('Category', 'wp-ultimate-csv-importer'); ?></span></label>
									</td>
									<td class='exportdatatype'><label> <input type="radio" name="export"
																			  value="marketpress"><span
												id="align"><?php echo __('Marketpress', 'wp-ultimate-csv-importer'); ?></span></label>
									</td>
								</tr>
								<tr>
									<td class='exportdatatype'><label> <input type="radio" name="export"
																			  value="tags"><span
												id="align"><?php echo __('Tags', 'wp-ultimate-csv-importer'); ?>
										</label></span></td>
									<td class='exportdatatype'><label> <input type="radio" name="export"
																			  value="customerreviews"><span
												id="align"><?php echo __('Customer Reviews', 'wp-ultimate-csv-importer'); ?></span></label>
									</td>
								</tr>
								<tr>
									<td class='exportdatatype'>
										<label> <input type="radio" name="export" value="customtaxonomy"><span
												id="align"><?php echo __('Custom Taxonomy', 'wp-ultimate-csv-importer'); ?></span></label>
									...
									<td class='exportdatatype'><label> <input type="radio" name="export"
																			  value="comments"><span
												id="align"><?php echo __('Comments', 'wp-ultimate-csv-importer'); ?></span></label>
									</td>
								</tr>
								<tr>
									<td class='exportdatatype'><label> <input type="radio" name="export"
																			  value="users"><span
												id="align"><?php echo __('Users', 'wp-ultimate-csv-importer'); ?></span></label>
									</td>
...
*/ ?>
						<div class='form-group exportedas'>
							<label
								class='col-sm-2 control-label'><b><?php echo __('File Name:', 'wp-ultimate-csv-importer'); ?> </b></label>

							<div class='col-sm-6'>
								<input class='form-control' type='text' name='export_filename' id='export_filename'
									   value=''

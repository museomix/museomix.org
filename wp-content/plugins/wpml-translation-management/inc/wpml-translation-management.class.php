...
class WPML_Translation_Management{
	...
	function activate_translation_analytics() {
		...
		} else if ( defined('ENABLE_TRANSLATION_ANALYTICS') && ENABLE_TRANSLATION_ANALYTICS && $this->is_module_valid("WPML_Translation_Analytics") ) {
	...
	function remove_deprecated_translaton_analytics_menu() {
		...
		if ( defined( 'WPML_TRANSLATION_ANALYTICS_FOLDER' ) ) {
	...
	protected function handle_notices() {
		global $pagenow;

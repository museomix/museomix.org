jQuery(document).ready(function(){
    ...
    jQuery(document).ajaxSuccess(function(evt, request, settings) {
        ...
        if(typeof settings === 'undefined' || typeof settings.data === 'undefined')  return;
    ...
    jQuery(document).delegate('.icl_error_input', 'focus', function(){jQuery(this).removeClass('icl_error_input')});
